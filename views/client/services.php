            ...
            <div class="row">
                <div class="col-lg-8 order-lg-2">
                    <div class="services__details">
                        ...
                        <div class="services__details__pic">
                            <img src="assetsv2/img/services/services-details.jpg" alt="">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="services__details__item__pic">
                                    <img src="assetsv2/img/services/sd-1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="services__details__item__pic">
                                    <img src="assetsv2/img/services/sd-2.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="services__details__item__pic">
                                    <img src="assetsv2/img/services/sd-3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 order-lg-1">
                    <div class="services__sidebar">
                        <div class="services__accordion">
                            <div class="services__title">
                                <h4><img src="assetsv2/img/icons/services-icon.png" alt=""> All services</h4>
                            </div>
                    ...
                    <div class="services__appoinment">
                        <div class="services__title">
                            <h4><img src="assetsv2/img/icons/services-icon.png" alt=""> Get an appointment</h4>
                        </div>
                        <form action="#">
