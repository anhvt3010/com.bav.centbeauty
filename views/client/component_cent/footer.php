        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-6">
                <div class="footer__widget">
                    ...
                    <ul>
                        <li><a href="#">Chất Làm Đầy Da Mặt</a></li>
                        <li><a href="#">Phẫu Thuật Ngực</a></li>
                        <li><a href="#">Nâng Cơ Thể</a></li>
                        <li><a href="#">Mặt & Cổ</a></li>
                        <li><a href="#">Giảm Mỡ</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="footer__address">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-envelope"></i> centbeauty@gmail.com</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="footer__copyright__text">
                        <p>Copyright &copy;
                            ...
                            <a href="https://colorlib.com" target="_blank">Beauty Cent'</a>
                        </p>
                    </div>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
